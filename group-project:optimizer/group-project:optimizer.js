...
Optimizer = (function () {
  ...
  Optimizer.prototype.optimize = function (currentValue) {
    ...
    else // if we are tweaking the t, make sure that it's not above 0.5, it's a really thick airfoil already
    // TODO find a way remove it from here
    if (this.tweakedParameter === 0 && this.currentParameters[this.tweakedParameter] > 0.5) {
      this.currentParameters[this.tweakedParameter] = 0.5;
    }
    // if we are tweaking the theta, make sure that it's not above PI, it doesn't make sense
    // TODO find a way remove it from here
    else if (this.tweakedParameter === 1 && this.currentParameters[this.tweakedParameter] > Math.PI) {
      this.currentParameters[this.tweakedParameter] = Math.PI;
    }
    // if we are tweaking the theta, make sure that it's not under PI/2, it doesn't make sense
    // TODO find a way remove it from here
